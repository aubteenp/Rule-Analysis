...
RD model with only 6 mos before and after cutoff
...
rd_model_filtered <- lm(proportion_rules ~ treatment + distance + I(distance^2), 
...
RD Model with all data (does not include Jan 2025).
