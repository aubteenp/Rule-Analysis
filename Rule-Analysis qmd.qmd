...
-   ($$X_i$$ ): Running Variable representing the distance from the cutoff (June 2024) for month $i$). Typically measured in months: $X_i$ = Number of months since June 2024
...
-   ( $M_{im}$ ): Monthly Dummy Variables for each month ( m ) (January to December), excluding one month to avoid multicollinearity (e.g., January as the reference category).
