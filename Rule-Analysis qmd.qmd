...
#Combining multiple FDA rule viles

# Define the list of file names
files <- c(
  "1st FDA pull - 12_18_2024 to 1_4_2016.csv",
  "2nd FDA pull - 11_25_2005 to 12_28_2015.csv",
  "3rd FDA pull - 11_25_2005 to 7_19_1999.csv",
  "4th FDA pull - 7_13_1999 to 1_4_1994.csv"
)
...
for (i in seq_along(files)) {
  tempdf <- read.csv(files[i], stringsAsFactors = FALSE)
  list_of_dfs[[i]] <- tempdf
}
